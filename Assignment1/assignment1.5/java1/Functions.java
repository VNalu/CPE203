...
//    }
      ...
      ImageStore imageStore, EventScheduler scheduler)
   {
      ...
      Entity blob = createOreBlob(entity.id + BLOB_ID_SUFFIX, pos, entity.actionPeriod / BLOB_PERIOD_SCALE,
         BLOB_ANIMATION_MIN +
      ...
      WorldModel world, ImageStore imageStore)
   {
      ...
      case QUAKE:
         scheduleEvent(scheduler, entity, createActivityAction(entity, world, imageStore),
            entity.actionPeriod);
         scheduleEvent(scheduler, entity,
