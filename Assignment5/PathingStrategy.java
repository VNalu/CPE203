...
interface PathingStrategy {
    ...
    */
    ...
    List<Point> computePath(Point start, Point end,
        Predicate<Point> canPassThrough, // determine if both a valid position in the world and a location to which the traveler can move
        BiPredicate<Point, Point> withinReach, // path is complete when a point is reached that is withinReach of the end point
        Function<Point, Stream<Point>> potentialNeighbors); // the directions in which travel might be able to proceed
